...
function buildFallbackStructuredWriteFeedback(
    ...
    return {
        ...
        improvements,
        requirementChecks,
        suggestedAnswer: answer.trim() || challenge.sampleAnswer?.trim() || '',
    }
}
    ...
    try {
        const response = await client.responses.create({
            ...
            instructions: [
                ...
                'Use the task and required targets only as context for what the learner was trying to express.',
                ...
                'Tie every improvement and requirement note to a specific word, phrase, sentence, or omitted target in the learner answer.',
