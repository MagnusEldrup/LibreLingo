...
function buildPrompt(
    ...
    return [
        ...
        'If a contrast like `waan` versus `baan` is the real issue, mention that contrast directly and explain which structure fits this meaning.',
        ...
        'Scoring guide: use 4-5 when the reply is understandable and mostly grammatical, 3 when the meaning is clear but there is a notable grammar issue, and 1-2 only when the reply is hard to understand or misses the task.',
    ].join('\n')
}
